...
fn vs_main(
    ...
    let chunk_local = vec3<u32>(local_x, local_y, local_z);
    // The position of the vertex in world-space coordinates.
    let local_pos = vec3<f32>(chunk_local) + vertex_pos;
    ...
    output.position = instant_uniforms.camera * vec4(local_pos, 1.0);
